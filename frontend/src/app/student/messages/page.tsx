...
export default function StudentMessagesPage() {
  ...
  useEffect(() => {
    ...
    // Live messaging polling (every 4 seconds)
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-1">
            {loadingContacts ? (
              ...
              <div className="py-12 text-center">
                <p className="text-gray-400 text-xs font-bold">No instructors found</p>
              </div>
            ) : (
        ...
        <div className="flex-1 flex flex-col h-full bg-white relative">
          {selectedContact ? (
            <>
              ...
              <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm">{selectedContact.name}</h4>
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">{selectedContact.className || 'Class Instructor'}</p>
                  </div>
                </div>
                <button
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-4">
                {loadingMessages && messages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest animate-pulse">Retrieving secure conversation...</p>
                  </div>
                ) : messages.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center p-6">
                    ...
                    <p className="text-gray-400 text-xs font-medium max-w-sm mt-1">Send a secure message to start your conversation with {selectedContact.name}.</p>
                  </div>
                ) : (
                  messages.map((msg) => {
            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-8 bg-gray-50/20">
              ...
              <p className="text-gray-400 text-xs font-semibold max-w-sm mt-1.5">Please select an instructor from the sidebar list to begin a secure direct conversation.</p>
            </div>
          )}
        </div>
