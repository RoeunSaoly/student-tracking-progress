 ...
 */
router.post("/submissions", authenticate, authorizePermission("assignment.submit"), controller.submitAssignment);
 ...
 */
router.get("/submissions", authenticate, authorizePermission("submission.view"), controller.getSubmissions);
 ...
 */
router.get("/submissions/me", authenticate, authorizePermission("submission.view"), controller.getMySubmissions);
